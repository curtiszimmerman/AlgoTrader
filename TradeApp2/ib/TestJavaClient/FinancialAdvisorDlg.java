...
public class FinancialAdvisorDlg extends JDialog {
	...
	private final int	      EDITOR_HEIGHT	      = 240;
	private final int	      BUTTON_PANEL_HEIGHT	= 60;
	private final JButton	  m_ok	              = new JButton("OK");
	private final JButton	  m_cancel	          = new JButton("Cancel");
	private final IBTextPanel	groupTextEditor	  = new IBTextPanel("Groups",
	                                                      true);
	private final IBTextPanel	profileTextEditor	= new IBTextPanel(
	                                                      "Allocation Profiles",
	                                                      true);
	private final IBTextPanel	aliasTextEditor	  = new IBTextPanel("Aliases",
	                                                      true);
	String	                  groupsXML;
	String	                  profilesXML;
	String	                  aliasesXML;
	...
	public FinancialAdvisorDlg(final Frame owner) {
		super(owner, "Financial Advisor", true);
		
		final IBGridBagPanel editPanel = new IBGridBagPanel();
	...
	void receiveInitialXML(final String p_groupsXML,
	        final String p_profilesXML, final String p_aliasesXML) {
