...
public class ConnectDlg extends JDialog {
	...
	public ConnectDlg(final Frame owner) {
		super(owner, true);
		...
		m_clientId.setText(Integer.toString(ConnectDlg.LAST_CLIENT_ID));
	...
	void onOk() {
		...
		try {
			...
			ConnectDlg.LAST_CLIENT_ID = m_retClientId;
	...
	void onCancel() {
		ConnectDlg.LAST_CLIENT_ID = Integer.parseInt(m_clientId.getText());
