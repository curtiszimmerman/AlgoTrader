...
public class FAAllocationInfoDlg extends JDialog {
	...
	public FAAllocationInfoDlg(final OrderDlg dlg) {
		super(dlg, false);
		m_parent = dlg;
		try {
			jbInit();
	...
	void jbInit() throws Exception {
		final Color etchedColor = new Color(148, 145, 140);
		final Border border1 = BorderFactory.createEtchedBorder(Color.white,
		        etchedColor);
		final Border border2 = BorderFactory.createEtchedBorder(Color.white,
		        etchedColor);
		final TitledBorder titledBorder1 = new TitledBorder(border1, "Group");
		final TitledBorder titledBorder2 = new TitledBorder(border2, "Profile");
