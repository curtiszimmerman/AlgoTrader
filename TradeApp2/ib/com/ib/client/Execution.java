...
public class Execution {
	...
	public Execution(final int p_orderId, final int p_clientId,
	        final String p_execId, final String p_time,
	                  final String p_acctNumber, final String p_exchange,
	        final String p_side, final int p_shares,
	                  final double p_price, final int p_permId,
	        final int p_liquidation, final int p_cumQty,
	                  final double p_avgPrice) {
		m_orderId = p_orderId;
	...
	public boolean equals(final Object p_other) {
		...
		if (p_other == null) {
			...
			final Execution l_theOther = (Execution) p_other;
