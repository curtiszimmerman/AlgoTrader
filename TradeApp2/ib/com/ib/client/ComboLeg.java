...
public class ComboLeg {
	...
	public int	            m_shortSaleSlot;	  // 1 = clearing broker, 2 =
												  // third party
	...
	public ComboLeg(final int p_conId, final int p_ratio,
	        final String p_action, final String p_exchange,
	        final int p_openClose) {
	...
	public ComboLeg(final int p_conId, final int p_ratio,
	        final String p_action, final String p_exchange,
	        final int p_openClose, final int p_shortSaleSlot,
	        final String p_designatedLocation) {
		m_conId = p_conId;
		m_ratio = p_ratio;
		m_action = p_action;
	...
	public boolean equals(final Object p_other) {
		if (this == p_other) {
			return true;
		} else if (p_other == null) { return false; }
		...
		if (m_conId != l_theOther.m_conId ||
		        ...
		        m_shortSaleSlot != l_theOther.m_shortSaleSlot) { return false; }
		...
		if (Util.StringCompareIgnCase(m_action, l_theOther.m_action) != 0 ||
		        ...
		        Util.StringCompareIgnCase(m_designatedLocation,
		                l_theOther.m_designatedLocation) != 0) { return false; }
