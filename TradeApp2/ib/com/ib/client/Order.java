...
public class Order {
	...
	public String	           m_tif;	                        // "Time in Force"
																// - DAY, GTC,
																// etc.
	public String	           m_ocaGroup;	                    // one cancels
																// all group
																// name
	public int	               m_ocaType;	                    // 1 =
																// CANCEL_WITH_BLOCK,
																// 2 =
																// REDUCE_WITH_BLOCK,
																// 3 =
	...
	public boolean	           m_transmit;	                    // if false,
																// order will be
																// created but
																// not
																// transmited
	public int	               m_parentId;	                    // Parent order
																// Id, to
																// associate
																// Auto STP or
																// TRAIL orders
	...
	public int	               m_triggerMethod;	            // 0=Default,
																// 1=Double_Bid_Ask,
																// 2=Last,
																// 3=Double_Last,
																// 4=Bid_Ask,
	...
	public String	           m_goodAfterTime;	            // FORMAT:
																// 20060505
																// 08:00:00
																// {time zone}
	public String	           m_goodTillDate;	                // FORMAT:
																// 20060505
																// 08:00:00
																// {time zone}
	public boolean	           m_overridePercentageConstraints;
	public String	           m_rule80A;	                    // Individual =
																// 'I', Agency =
																// 'A',
																// AgentOtherMember
																// = 'W',
	...
	public int	               m_minQty;
	public double	           m_percentOffset;	            // REL orders
																// only
	public double	           m_trailStopPrice;	            // for
																// TRAILLIMIT
																// orders only
	...
	public String	           m_openClose;	                // O=Open,
																// C=Close
	public int	               m_origin;	                    // 0=Customer,
																// 1=Firm
	public int	               m_shortSaleSlot;	            // 1 if you hold
																// the shares, 2
																// if they will
																// be delivered
																// from
																...
																// Only for
																// Action="SSHORT
	public String	           m_designatedLocation;	        // set when
																// slot=2 only.
	...
	public int	               m_auctionStrategy;	            // 1=AUCTION_MATCH,
																// 2=AUCTION_IMPROVEMENT,
	...
	public int	               m_volatilityType;	            // 1=daily,
																// 2=annual
	public int	               m_continuousUpdate;
	public int	               m_referencePriceType;	        // 1=Average, 2
																// = BidOrAsk
	public String	           m_deltaNeutralOrderType;
	public double	           m_deltaNeutralAuxPrice;
	
	// COMBO ORDERS ONLY
	public double	           m_basisPoints;	                // EFP orders
																// only
	public int	               m_basisPointsType;	            // EFP orders
																// only
	...
	public String	           m_clearingAccount;	            // True
																// beneficiary
																// of the order
	public String	           m_clearingIntent;	            // "" (Default),
																// "IB", "Away",
																// "PTA"
																// (PostTrade)
	...
	public Order() {
		m_outsideRth = false;
		m_openClose = "O";
		m_origin = Order.CUSTOMER;
		m_transmit = true;
		m_designatedLocation = Order.EMPTY_STR;
		...
		m_deltaNeutralOrderType = Order.EMPTY_STR;
	...
	public boolean equals(final Object p_other) {
		...
		final Order l_theOther = (Order) p_other;
		
		if (m_permId == l_theOther.m_permId) { return true; }
		...
		if (m_orderId != l_theOther.m_orderId ||
		        ...
		        m_notHeld != l_theOther.m_notHeld) { return false; }
		...
		if (Util.StringCompare(m_action, l_theOther.m_action) != 0 ||
		        ...
		        Util.StringCompare(m_algoStrategy, l_theOther.m_algoStrategy) != 0) { return false; }
		
		if (!Util.VectorEqualsUnordered(m_algoParams, l_theOther.m_algoParams)) { return false; }
