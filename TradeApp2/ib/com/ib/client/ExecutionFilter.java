...
public class ExecutionFilter {
	...
	public ExecutionFilter(final int p_clientId, final String p_acctCode,
	        final String p_time,
	        final String p_symbol, final String p_secType,
	        final String p_exchange, final String p_side) {
