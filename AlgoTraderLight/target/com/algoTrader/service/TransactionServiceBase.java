...
/**
 * <p>
 * Spring Service base class for <code>com.algoTrader.service.TransactionService</code>,
    ...
    implements com.algoTrader.service.TransactionService
{
    ...
    /**
     * @see com.algoTrader.service.TransactionService#executeTransaction(java.lang.String, com.algoTrader.vo.OrderVO)
     */
    public com.algoTrader.entity.Order executeTransaction(java.lang.String strategyName, com.algoTrader.vo.OrderVO order)
    {
        ...
        if (order.getStrategyName() == null || order.getStrategyName().trim().length() == 0)
        {
            throw new IllegalArgumentException(
        ...
        try
        {
            return this.handleExecuteTransaction(strategyName, order);
        }
        catch (Throwable th)
        {
            throw new com.algoTrader.service.TransactionServiceException(
                "Error performing 'com.algoTrader.service.TransactionService.executeTransaction(java.lang.String strategyName, com.algoTrader.vo.OrderVO order)' --> " + th,
                th);
        }
    }

     /**
      * Performs the core logic for {@link #executeTransaction(java.lang.String, com.algoTrader.vo.OrderVO)}
      */
    protected abstract com.algoTrader.entity.Order handleExecuteTransaction(java.lang.String strategyName, com.algoTrader.vo.OrderVO order)
