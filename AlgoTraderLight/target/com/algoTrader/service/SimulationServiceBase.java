 ...
 * <code>com.algoTrader.service.SimulationService</code>, provides access to all
...
public abstract class SimulationServiceBase
	...
	public void resetDB() {
		try {
			...
			throw new com.algoTrader.service.SimulationServiceException(
			        "Error performing 'com.algoTrader.service.SimulationService.resetDB()' --> " +
			                th,
			        th);
		}
	}
	...
	public void inputCSV() {
		try {
			...
			throw new com.algoTrader.service.SimulationServiceException(
			        "Error performing 'com.algoTrader.service.SimulationService.inputCSV()' --> " +
			                th,
			        th);
		}
	}
	...
	public com.algoTrader.vo.SimulationResultVO runByUnderlayings() {
		try {
			return handleRunByUnderlayings();
		} catch (final Throwable th) {
			throw new com.algoTrader.service.SimulationServiceException(
			        "Error performing 'com.algoTrader.service.SimulationService.runByUnderlayings()' --> " +
			                th,
			        th);
		}
	}
	 ...
	 */
	protected abstract com.algoTrader.vo.SimulationResultVO
	        handleRunByUnderlayings()
	                throws java.lang.Exception;
	...
	public void simulateWithCurrentParams() {
		try {
			handleSimulateWithCurrentParams();
		} catch (final Throwable th) {
			throw new com.algoTrader.service.SimulationServiceException(
			        "Error performing 'com.algoTrader.service.SimulationService.simulateWithCurrentParams()' --> " +
			                th,
			        th);
		}
	}
	...
	public com.algoTrader.vo.SimulationResultVO getSimulationResultVO(
		...
		try {
			return handleGetSimulationResultVO(startTime);
		} catch (final Throwable th) {
			throw new com.algoTrader.service.SimulationServiceException(
			        "Error performing 'com.algoTrader.service.SimulationService.getSimulationResultVO(long startTime)' --> " +
			                th,
			        th);
		}
	}
	 ...
	 */
	protected abstract com.algoTrader.vo.SimulationResultVO
	        handleGetSimulationResultVO(long startTime)
	                throws java.lang.Exception;
