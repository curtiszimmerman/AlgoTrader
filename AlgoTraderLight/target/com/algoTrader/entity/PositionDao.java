...
public interface PositionDao {
	...
	/**
	 * Loads an instance of com.algoTrader.entity.Position from the persistent
	 * store.
	 */
	...
	/**
	 * Creates an instance of com.algoTrader.entity.Position and adds it to the
	 * persistent store.
	 */
	...
	/**
	 * <p>
	 * Does the same thing as {@link #create(com.algoTrader.entity.Position)}
	 ...
	 */
	public Object
	        create(int transform, com.algoTrader.entity.Position position);
	 ...
	 * 
	 * @param entities
	 *            the collection of com.algoTrader.entity.Position
	 *            instances to create.
	 * 
	...
	/**
	 * <p>
	 * Creates a new <code>com.algoTrader.entity.Position</code> instance from
	 ...
	 * {@link #create(long, java.lang.Double, java.math.BigDecimal)} with an
	...
	/**
	 * <p>
	 * Does the same thing as {@link #create(long)} with an additional flag
	...
	/**
	 * Removes the instance of com.algoTrader.entity.Position from the
	 * persistent store.
	 */
 ...
 * 
	...
	/**
	 * <p>
	 * Does the same thing as {@link #findOpenPositions()} with an additional
	 ...
	 * defined in {@link #findOpenPositions(int)}.
	 * </p>
	 */
 ...
 * 
	 ...
	 * <p>
	 * Does the same thing as
	 * {@link #findOpenPositionsByStrategy(java.lang.String)} with an additional
	 * argument called <code>queryString</code>. This <code>queryString</code>
	 * argument allows you to override the query string defined in
	 * {@link #findOpenPositionsByStrategy(java.lang.String)}.
	 * </p>
	 */
	public java.util.List findOpenPositionsByStrategy(String queryString,
	        java.lang.String strategyName);
	 ...
	 * </p>
	 */
	public java.util.List findOpenPositionsByStrategy(int transform,
	        java.lang.String strategyName);
	
	/**
	 * <p>
	 * Does the same thing as
	 * {@link #findOpenPositionsByStrategy(boolean, java.lang.String)} with an
	 * additional argument called <code>queryString</code>. This
	 * <code>queryString</code> argument allows you to override the query string
	 * defined in {@link #findOpenPositionsByStrategy(int, java.lang.String
	 * strategyName)}.
	 * </p>
	 */
	public java.util.List findOpenPositionsByStrategy(int transform,
	        String queryString, java.lang.String strategyName);
 ...
 * 
	 ...
	 * </p>
	 */
	public com.algoTrader.entity.Position findByIdFetched(String queryString,
	        int id);
 ...
 * 
	 ...
	 * <p>
	 * Does the same thing as
	 * {@link #findBySecurityAndStrategy(int, java.lang.String)} with an
	 * additional argument called <code>queryString</code>. This
	 * <code>queryString</code> argument allows you to override the query string
	 * defined in {@link #findBySecurityAndStrategy(int, java.lang.String)}.
	 * </p>
	 */
	public com.algoTrader.entity.Position findBySecurityAndStrategy(
	        String queryString, int securityId, java.lang.String strategyName);
	 ...
	 * </p>
	 */
	public Object findBySecurityAndStrategy(int transform, int securityId,
	        java.lang.String strategyName);
	
	/**
	 * <p>
	 * Does the same thing as
	 * {@link #findBySecurityAndStrategy(boolean, int, java.lang.String)} with
	 * an additional argument called <code>queryString</code>. This
	 * <code>queryString</code> argument allows you to override the query string
	 * defined in {@link #findBySecurityAndStrategy(int, int securityId,
	 * java.lang.String strategyName)}.
	 * </p>
	 */
	public Object findBySecurityAndStrategy(int transform, String queryString,
	        int securityId, java.lang.String strategyName);
