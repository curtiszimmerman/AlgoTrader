...
public interface WatchListItemDao {
	...
	/**
	 * Loads an instance of com.algoTrader.entity.WatchListItem from the
	 * persistent store.
	 */
	...
	/**
	 * Creates an instance of com.algoTrader.entity.WatchListItem and adds it to
	 * the persistent store.
	 */
	public com.algoTrader.entity.WatchListItem create(
	        com.algoTrader.entity.WatchListItem watchListItem);
	
	/**
	 * <p>
	 * Does the same thing as
	 * {@link #create(com.algoTrader.entity.WatchListItem)} with an additional
	 ...
	 * 
	 * @param entities
	 *            the collection of com.algoTrader.entity.WatchListItem
	 *            instances to create.
	 * 
	...
	/**
	 * <p>
	 * Creates a new <code>com.algoTrader.entity.WatchListItem</code> instance
	...
	/**
	 * <p>
	 * Does the same thing as {@link #create(boolean)} with an additional flag
	 ...
	 * <p>
	 * Creates a new <code>com.algoTrader.entity.WatchListItem</code> instance
	 * from only <strong>required</strong> properties (attributes and
	 * association ends) and adds it to the persistent store.
	 * </p>
	 */
	public com.algoTrader.entity.WatchListItem create(
	        boolean persistent,
	...
	/**
	 * Removes the instance of com.algoTrader.entity.WatchListItem from the
	 * persistent store.
	 */
	public void remove(com.algoTrader.entity.WatchListItem watchListItem);
	
	/**
	 * Removes the instance of com.algoTrader.entity.WatchListItem having the
 ...
 * 
	 ...
	 * <p>
	 * Does the same thing as
	 * {@link #findByStrategyAndSecurity(com.algoTrader.entity.Strategy, com.algoTrader.entity.Security)}
	 ...
	 */
	public com.algoTrader.entity.WatchListItem findByStrategyAndSecurity(
	        String queryString, com.algoTrader.entity.Strategy strategy,
	        com.algoTrader.entity.Security security);
	 ...
	 * set to <code>TRANSFORM_NONE</code> then finder results will
	 * <strong>NOT</strong> be transformed during retrieval. If this flag is any
	 * of the other constants defined here then finder results <strong>WILL
	 * BE</strong> passed through an operation which can optionally transform
	 * the entities (into value objects for example). By default, transformation
	 * does not occur.
	 * </p>
	 */
	public Object findByStrategyAndSecurity(int transform,
	        com.algoTrader.entity.Strategy strategy,
	        com.algoTrader.entity.Security security);
	 ...
	 * <p>
	 * Does the same thing as
	 * {@link #findByStrategyAndSecurity(boolean, com.algoTrader.entity.Strategy, com.algoTrader.entity.Security)}
	 * with an additional argument called <code>queryString</code>. This
	 * <code>queryString</code> argument allows you to override the query string
	 * defined in {@link #findByStrategyAndSecurity(int,
	 * com.algoTrader.entity.Strategy strategy, com.algoTrader.entity.Security
	 * security)}.
	 * </p>
	 */
	public Object findByStrategyAndSecurity(int transform, String queryString,
	        com.algoTrader.entity.Strategy strategy,
	        com.algoTrader.entity.Security security);
