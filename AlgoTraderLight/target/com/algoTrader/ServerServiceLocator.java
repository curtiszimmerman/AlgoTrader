...
public class ServerServiceLocator implements CommonServiceLocator {
	 ...
	 */
	public final com.algoTrader.service.SimulationService
	        getSimulationService() {
		return (com.algoTrader.service.SimulationService) getContext().getBean(
		        "simulationService");
	}
	...
	public final org.hibernate.SessionFactory getSessionFactory() {
		return (org.hibernate.SessionFactory) getContext().getBean(
		        "sessionFactory");
	}
